  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row items-center gap-6 p-6 rounded-lg">
        <Avatar className="h-24 w-24 border-4 dark:border-slate-800 shadow-md">
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 items-center py-2">
              ...
              <span className="col-span-2 text-xs sm:text-sm font-mono dark:bg-slate-800 p-1 rounded">
                {user.id}
              </span>
            </div>
          </div>
